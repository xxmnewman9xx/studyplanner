        ...
        <Animated.View style={motionStyle}>
          {step === "name" ? (
            <>
              ...
              <TextInput autoFocus value={profile.name} onChangeText={(name) => setProfile((current) => ({ ...current, name }))} placeholder="Your first name" placeholderTextColor={theme.label3} returnKeyType="next" onSubmitEditing={() => next()} style={{ marginTop: 26, minHeight: 58, borderRadius: 20, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: theme.hairline, color: theme.label, paddingHorizontal: 18, fontSize: 20, fontWeight: "900" }} />
