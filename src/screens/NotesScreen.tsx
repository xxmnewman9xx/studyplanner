...
function createStyles(theme: AppTheme) {
  ...
  return StyleSheet.create({
    ...
    heroCard: { padding: spacing.xl, gap: spacing.md, overflow: "hidden" },
    ...
    heroTitle: { color: colors.ink, fontSize: 34, lineHeight: 39, fontWeight: "900", letterSpacing: 0 },
    heroText: { color: colors.muted, fontSize: 16, lineHeight: 23, fontWeight: "700" },
    heroStats: { flexDirection: "row", gap: spacing.sm, marginTop: spacing.xs },
    miniStat: { flex: 1, minWidth: 0, borderRadius: radii.lg, backgroundColor: colors.surfaceAlt, padding: spacing.md },
    miniStatValue: { color: colors.ink, fontSize: 19, lineHeight: 23, fontWeight: "900" },
