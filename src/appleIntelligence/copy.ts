...
export const APP22_COPY_EN: Record<string, string> = {
  ...
  "ai.brief.line": "Now: {minutes} min {title}",
  "ai.brief.reason_task_today": "It's due today. Finish it first.",
  "onboarding.option_camera_hint": "Point at each page. Tables read row by row.",
  "onboarding.option_pdf_hint": "Multi-page syllabi and course handouts.",
  "onboarding.option_paste_hint": "From Canvas, email, or a document.",
  "onboarding.option_manual_hint": "Type a class and its first deadline.",
  ...
  "paywall.accessibility_plan_hint": "Select this subscription plan",
  ...
  "paywall.purchase_failed": "The App Store could not start the purchase.",
  "paywall.restore_none": "No active StudyPlanner subscription was found for this Apple ID.",
  "paywall.restore_failed": "Restore could not be completed.",
  "ai.check.kicker": "QUICK CHECK · FROM YOUR NOTES",
  "ai.check.option_hint": "Choose this answer",
  "ai.check.source": "From your notes{line}: “{quote}”",
  "ai.check.line": "line {line}",
  "review.full_title": "This review is full",
  "review.full_body": "{count} rows didn't fit (a review holds 80). Apply this review, then add the rest.",
  ...
  "ai.exam.review_confirm_title": "Add review sessions ({count})?",
