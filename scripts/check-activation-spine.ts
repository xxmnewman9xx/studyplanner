...
expect(appSource.includes('maybeShowUnlockSuccess("purchase_action")'), "purchase success may show unlock alert");
expect(appSource.includes('maybeShowUnlockSuccess("restore_action")'), "restore success may show unlock alert");
