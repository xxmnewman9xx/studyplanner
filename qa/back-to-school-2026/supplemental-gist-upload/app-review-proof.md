...
- submitted iOS build `2.0.8` build `79`,
...
- The local simulator proof used the freshest available release simulator artifact on disk (`2.0.6` build `76`); the replacement App Store build is `2.0.8` build `79`, and the current source/config preserve the same scheme and route parser.
