...
Current evidence-adjusted score after screenshot capture and contact-sheet proof: **8.52/10**.
...
Total weighted score at branch start: **7.82/10**. Current evidence-adjusted score: **8.52/10**.
