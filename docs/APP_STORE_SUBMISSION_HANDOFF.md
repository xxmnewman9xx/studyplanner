...
- Missing: products-loaded paywall, upload/photo/parser-success states, restore purchases, localized UI screenshots/string extraction, full VoiceOver/contrast pass, iPad screenshots, and optional overnight widget rollover screenshot.
