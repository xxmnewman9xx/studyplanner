...
3. Fresh screenshot folder is incomplete: 27 raw simulator PNGs and a contact sheet are captured, but remaining required states are missing.
...
- 27 raw simulator PNGs captured.
...
- Missing: products-loaded paywall, upload/photo/manual/parser-success states, restore purchases, localized UI screenshots/string extraction, full VoiceOver/Dynamic Type screen sweep, iPad screenshots, and widget add/edit/day-boundary refresh proof.
