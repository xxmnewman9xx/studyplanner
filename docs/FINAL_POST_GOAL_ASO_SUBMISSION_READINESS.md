...
Current evidence-adjusted score after fixes/docs/screenshots/accessibility/date/widget quick wins: 8.99/10.
Target: 9.4/10.  
Verdict: not reached.
...
- 35 raw simulator PNGs were captured in `artifacts/post-goal-aso-submission`.
