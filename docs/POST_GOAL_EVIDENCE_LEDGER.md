...
| --- | --- | --- | --- |
| Widget refresh after add/edit/day-boundary | Refresh after completing a real assignment is proven, but edit/add and midnight rollover remain unproven | Blocker for 9.4 claim; non-submit if documented | Edit or add an assignment, confirm App Group snapshot changes, and capture refreshed Home Screen widget; repeat day-boundary proof |
