...
| EV-028 | Contact sheet | `artifacts/post-goal-aso-submission/45-final-contact-sheet.png` | Contact sheet generated from current 29 raw PNGs, 1248x5328 | Screenshot proof | Captured |
...
| EV-039 | Widget add refresh proof | Normal-mode manual class/work add, App Group plist extraction, `artifacts/post-goal-aso-submission/widget-refresh-after-add-snapshot.json`, `artifacts/post-goal-aso-submission/48-widget-refresh-after-add.png` | Adding Field Notes to Science Lab updated native nextDue, This Week, and monthly due counts, and the installed Home Screen widgets rendered the added assignment | Widget refresh after planner adds | Add refresh proven; day-boundary still open |

## Open Evidence Gaps

| Gap | Why it matters | Current blocker status | Needed proof |
| --- | --- | --- | --- |
| Widget refresh after day-boundary | Refresh after completing, editing, and adding real assignments is proven, but midnight rollover remains unproven | Blocker for 9.4 claim; non-submit if documented | Advance/simulate day boundary, confirm due labels/counts change in App Group snapshot, and capture refreshed Home Screen widgets |
...
| Remaining raw screenshots | 29 PNGs are captured, but upload/file/photo/manual/parser/success/restore/localized states are still missing | Partial blocker for final asset package | Capture remaining supported states or document exclusions |
