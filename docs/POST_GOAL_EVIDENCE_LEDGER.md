...
| EV-028 | Contact sheet | `artifacts/post-goal-aso-submission/45-final-contact-sheet.png` | Contact sheet generated from current 36 raw PNGs, 1248x5994 | Screenshot proof | Captured |
...
| Remaining raw screenshots | 36 PNGs are captured, but upload/file/photo/parser/success/restore/localized states are still missing | Partial blocker for final asset package | Capture remaining supported states or document exclusions |
