...
| EV-028 | Contact sheet | `artifacts/post-goal-aso-submission/45-final-contact-sheet.png` | Contact sheet generated from current 41 raw PNGs, 1230x7305 | Screenshot proof | Captured |
...
| Remaining raw screenshots | 41 PNGs are captured, but restore, products-loaded paywall, localized UI, settings/reminders, native widget empty/needs-check, and App Store-sized export proof are still missing | Partial blocker for final asset package | Capture remaining supported states or document exclusions |
