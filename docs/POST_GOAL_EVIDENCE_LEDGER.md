...
| EV-028 | Contact sheet | `artifacts/post-goal-aso-submission/45-final-contact-sheet.png` | Contact sheet generated from current 25 PNGs, 1090x4302 | Screenshot proof | Captured |
...
| --- | --- | --- | --- |
| Widget refresh after completion/edit | Installed small/medium widget screenshots now exist, but refresh after changing a real assignment is not proven | Blocker for 9.4 claim; non-submit if documented | Complete/edit an assignment, confirm App Group snapshot changes, and capture refreshed Home Screen widget |
...
| Remaining raw screenshots | 25 PNGs are captured, but upload/file/photo/manual/parser/success/restore/app icon/localized states are still missing | Partial blocker for final asset package | Capture remaining supported states or document exclusions |
