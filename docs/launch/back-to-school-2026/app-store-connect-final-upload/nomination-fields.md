# Paste-Ready App Store Connect Fields
...
Related In-App Events: Add `Semester Kickoff Week` only after it is approved or selectable in App Store Connect.
...
Rules: use only these two files for the event. They are text-free, device-free, and do not contain fake app UI or fake widgets.
