...
- The App Store submitted version candidate remains `2.0.7` build `78` with the real screenshot set.
...
| Accessibility/localization summary | HTTP 200; build `2.0.7` / `78` and current verification date visible | https://gist.githubusercontent.com/xxmnewman9xx/8ce183d571c61df26dc64d69c429f166/raw/accessibility-localization-summary.md |
| App Review proof | HTTP 200; build `2.0.7` / `78` and claim boundaries visible | https://gist.githubusercontent.com/xxmnewman9xx/8ce183d571c61df26dc64d69c429f166/raw/app-review-proof.md |
...
- App Review rejects or blocks the submitted `2.0.7` build.
