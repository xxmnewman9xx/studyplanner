...
Study Planner does not sell personal information. Planner data is not shared with advertisers. Syllabus content is used for parsing only when you choose to import a syllabus.
