...
| App screenshots | [Screenshot specifications](https://developer.apple.com/help/app-store-connect/reference/app-information/screenshot-specifications) | Apple requires one to ten screenshots in `.jpeg`, `.jpg`, or `.png`. Current accepted iPhone 6.9-inch portrait sizes include 1260x2736, 1290x2796, and 1320x2868; current 13-inch iPad portrait sizes include 2064x2752 and 2048x2732. | Raw simulator screenshots are evidence. This branch now exports local candidate sets at 1290x2796 for iPhone and 2064x2752 for iPad, but App Store Connect upload acceptance still needs manual confirmation. |
...
3. Final App Store screenshots have local accepted-size exports, but still need manual App Store Connect upload acceptance.
